...
class StartupsControllerTest < ActionController::TestCase
  ...
  test "should create startup" do
    assert_difference('Startup.count') do
      post :create, startup: { contact_name: @startup.contact_name, country: @startup.country, email: @startup.email, industry: @startup.industry, startup_name: @startup.startup_name, tribe: @startup.tribe }
    end
  ...
  test "should update startup" do
    put :update, id: @startup, startup: { contact_name: @startup.contact_name, country: @startup.country, email: @startup.email, industry: @startup.industry, startup_name: @startup.startup_name, tribe: @startup.tribe }
    assert_redirected_to startup_path(assigns(:startup))
  end
