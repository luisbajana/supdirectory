...
class MentorsControllerTest < ActionController::TestCase
  ...
  test "should create mentor" do
    assert_difference('Mentor.count') do
      post :create, mentor: { country: @mentor.country, description: @mentor.description, email: @mentor.email, industry: @mentor.industry, name: @mentor.name }
    end
  ...
  test "should update mentor" do
    put :update, id: @mentor, mentor: { country: @mentor.country, description: @mentor.description, email: @mentor.email, industry: @mentor.industry, name: @mentor.name }
    assert_redirected_to mentor_path(assigns(:mentor))
  end
